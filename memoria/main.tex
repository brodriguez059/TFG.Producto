...
\input{0-Preambulo/paquetes}
\input{0-Preambulo/macros}
...
\pagestyle{plain}
% \input{2-Resumen/resumen}
% \input{2-Resumen/agradecimientos}
\pagestyle{plain}
\input{3-Indices/toc}
\input{3-Indices/lof}
% \input{3-Indices/lot}
...
% \input{4-Introduccion/introduccion}
\input{5-Cuerpo/cuerpo}
...
\pagestyle{plain}
\input{7-Bibliografía/bibliography}
\cleardoublepage
}
