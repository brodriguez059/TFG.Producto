...
proyectos desarrollados con este producto. \improvement{La utilización de una CLI ahora no
resulta viable, se cambia a GUI}
...
\begin{enumerate}
    ...
    \improvement{La utilización de una CLI ahora no resulta viable}
...
\begin{itemize}
    ...
    aplicación.
    \item El idioma en el que estará la aplicación será el inglés.\change{Igual
    conviene discutir esto}
...
% * Se define una tabla con el patrón de nombres de variables, constantes, funciones, clases, etc y toda la aplicación sigue esa sintaxis (legibilidad)
% \end{markdown}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        integración con el microframework. \improvement{La utilización de una CLI ahora no
        resulta viable}
    \end{itemize}
