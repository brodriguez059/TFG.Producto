...
%------------Información básica------------%
\newcommand{\egilea}{Baldwin David Rodríguez Ponce} % The full name of the author
\newcommand{\zuzendariak}{María Begoña Losada Pereda}
...
\newcommand{\izenburua}{Herramienta de generación de sistemas de simulación
dinámicos discretos} % The title of the thesis
